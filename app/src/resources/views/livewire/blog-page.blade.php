                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <article class="d-flex flex-column">
                            ...
                            <div class="post-img">
                                <img src="{{ asset('front/assets/img/blog/blog-4.jpg') }}" alt="" class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <article class="d-flex flex-column">
                            ...
                            <div class="post-img">
                                <img src="{{ asset('front/assets/img/blog/blog-5.jpg') }}" alt="" class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <article class="d-flex flex-column">
                            ...
                            <div class="post-img">
                                <img src="{{ asset('front/assets/img/blog/blog-6.jpg') }}" alt="" class="img-fluid">
                            </div>
