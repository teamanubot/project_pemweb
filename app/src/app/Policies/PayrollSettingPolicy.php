...
class PayrollSettingPolicy
{
    ...
    {
        return $user->can('view_any_payroll::setting');
    }
    ...
    {
        return $user->can('view_payroll::setting');
    }
    ...
    {
        return $user->can('create_payroll::setting');
    }
    ...
    {
        return $user->can('update_payroll::setting');
    }
    ...
    {
        return $user->can('delete_payroll::setting');
    }
    ...
    {
        return $user->can('delete_any_payroll::setting');
    }
     ...
     */
    public function replicate(User $user, PayrollSetting $payrollSetting): bool
    {
